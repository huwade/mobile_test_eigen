...
py::array_t<float> py_multiply_matrix_mat0_mat1(py::array_t<float, py::array::f_style | py::array::forcecast> array, 
                                      py::array_t<float, py::array::f_style | py::array::forcecast> array1)
{
    
    // allocate std::vector (to pass to the C++ function)
    MatrixXf mat1(1,16), mat2(16,16), outmat(1,16);

    // copy py::array -> std::vector
    std::memcpy(mat2.data(), array1.data(), array1.size()*sizeof(float));
    std::memcpy(mat1.data(), array.data() , array.size()*sizeof(float));
    
    outmat = multiply_matrix_mat0_mat1(mat1, mat2);
...
// wrap C++ function with NumPy array IO
py::array_t<float> py_multiply_matrix_tmp1_mat2(py::array_t<float, py::array::f_style | py::array::forcecast> array, 
                                      py::array_t<float, py::array::f_style | py::array::forcecast> array1)
{
    ...
    outmat = multiply_matrix_tmp1_mat2(mat1, mat2);
...
PYBIND11_MODULE(matrix_dot,m)
{
    ...
    m.def("layer7_core_mat0_mat1_dot", &py_multiply_matrix_mat0_mat1, "multiply python array's element ");
    m.def("layer7_core_tmp1_mat2_dot", &py_multiply_matrix_tmp1_mat2, "multiply python array's element ");
}